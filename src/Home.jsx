  ...
  return (
    <div className="home-container">
      <div className="jumbotron text-center mt-0 welcome">
        ...
        <div className="col-md">
          <form onSubmit={handleSearchSubmit} className="search-form">
            ...
            />
            <button
              className="  btn-outline-secondary search-button"
              type="submit"
            >
      ...
      <div className="container text-center">
        ...
        <Link to="/login" className="nav-link"> <div className="feature-box">
              <FontAwesomeIcon
                icon={faHeart}
                size="3x"
      ...
      <div className="jumbotron text-center mt-5 mb-0">
        ...
        <div className="contactus">
          <p>
            We provide the best tools and resources to make your wedding
            planning process smooth and enjoyable. From managing your budget to
            coordinating with vendors, we have got you covered.
          </p>
